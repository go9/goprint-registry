defmodule GoprintRegistryWeb.UserAuth do
  use GoprintRegistryWeb, :verified_routes
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GoprintRegistryWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      GoprintRegistryWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule GoprintRegistryWeb.PageLive do
        use GoprintRegistryWeb, :live_view

        on_mount {GoprintRegistryWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{GoprintRegistryWeb.UserAuth, :require_authenticated}] do
