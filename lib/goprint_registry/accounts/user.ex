defmodule GoprintRegistry.Accounts.User do
  ...
  It accepts email and password, validates both, and hashes the password.
  """
  ...
  defp validate_email_for_registration(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, GoprintRegistry.Repo)
  ...
  """
  def valid_password?(%GoprintRegistry.Accounts.User{hashed_password: hashed_password}, password)
