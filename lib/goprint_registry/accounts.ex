defmodule GoprintRegistry.Accounts do
  @moduledoc """
  ...
  @doc """
  Returns an `%Ecto.Changeset{}` for tracking user changes for registration.
  ...
  See `GoprintRegistry.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `GoprintRegistry.Accounts.User.password_changeset/3` for a list of supported options.
